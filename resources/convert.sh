...
mono embedconv2.exe -in gfx_titlebkg.png -outc res_graphics_titlebkg.c -outh res_graphics_titlebkg.h -palette pal_game.gpl -tile 8 8 -sprite 1 1 -8bpp -structdef "kit.h"
